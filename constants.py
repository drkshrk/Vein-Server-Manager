...
GAMEPLAY_DEFINITIONS = {
    "General & Loot": [
        ...
        ("Furn. Respawn Rate", "vein.Furniture.RespawnRate", "Cooldown Seconds (Higher=Slower).", "str", "Engine", "ConsoleVariables", "900.0"),
        ("Max Utility Cabinets", "vein.Placement.MaxUtilityCabinets", "Limit per area. 0=Unlimited.", "str", "Engine", "ConsoleVariables", "0"),
        ("Wire Max Radius", "vein.Wire.MaxRadius", "Electrical wire range.", "str", "Engine", "ConsoleVariables", "1500"),
        ("TV Max Radius", "vein.Wire.TVMaxRadius", "Electrical range for TVs.", "str", "Engine", "ConsoleVariables", "1500"),
        ("Hideable Clothes", "vein.ClothingHideable", "Can armor be hidden?", "bool", "Engine", "ConsoleVariables", False),
    ],
    "Survival & Time": [
        ("Time Multiplier", "vein.Time.TimeMultiplier", "Day Speed (Higher=Faster Days).", "str", "Engine", "ConsoleVariables", "15.1"),
        ("Night Multiplier", "vein.Time.NightTimeMultiplier", "Night Speed (Higher=Faster Night).", "str", "Engine", "ConsoleVariables", "3.2"),
        ("Night Start Hour", "vein.Time.NightTimeMultiplierStart", "Hour night begins (24h).", "str", "Engine", "ConsoleVariables", "20.0"),
        ("Night End Hour", "vein.Time.NightTimeMultiplierEnd", "Hour night ends (24h).", "str", "Engine", "ConsoleVariables", "6.0"),
        ("Time Passes Empty", "vein.Time.ContinueWithNoPlayers", "Time runs when empty?", "bool", "Engine", "ConsoleVariables", False),
        ("Hunger Multiplier", "GS_HungerMultiplier", "Drain Speed (Higher=Starve Faster).", "str", "Game", "/Script/Vein.ServerSettings", "1.0"),
        ("Thirst Multiplier", "GS_ThirstMultiplier", "Drain Speed (Higher=Thirst Faster).", "str", "Game", "/Script/Vein.ServerSettings", "1.0"),
        ("Global XP Mult", "vein.Stats.XPMultiplier", "XP Gain (2.0 = Double XP).", "str", "Engine", "ConsoleVariables", "1.0"),
        ("Start Offset Days", "vein.Time.StartOffsetDays", "Days passed at start.", "str", "Engine", "ConsoleVariables", "0"),
        ("Elec Shutoff Day", "vein.Calendar.ElectricalShutoffTimeDays", "Day grid fails.", "str", "Engine", "ConsoleVariables", "46"),
    ...
    "Zombies (The Horde)": [
        ...
        ("Headshots Only", "vein.Zombies.HeadshotOnly", "Only headshots kill.", "bool", "Engine", "ConsoleVariables", False),
        ("Spawn Density", "vein.AISpawner.SpawnCapMultiplierZombie", "Higher = More Zombies.", "str", "Engine", "ConsoleVariables", "1.0"),
        ("Run Speed Mult", "vein.Zombies.RunSpeedMultiplier", "Sprinters Speed (Higher=Faster).", "str", "Engine", "ConsoleVariables", "1.0"),
        ("Walk Speed Mult", "vein.Zombies.WalkSpeedMultiplier", "Walkers Speed (Higher=Faster).", "str", "Engine", "ConsoleVariables", "1.0"),
        ("Crawl Speed Mult", "vein.Zombies.CrawlSpeedMultiplier", "Crawlers Speed (Higher=Faster).", "str", "Engine", "ConsoleVariables", "1.0"),
        ("Global Speed Mult", "vein.Zombies.SpeedMultiplier", "All Zombies Speed.", "str", "Engine", "ConsoleVariables", "1.0"),
        ("Horde Mode", "vein.AISpawner.Hordes.Enabled", "Roaming hordes?", "bool", "Engine", "ConsoleVariables", True),
        ("Always Turn", "vein.AlwaysBecomeZombie", "Players turn on death.", "bool", "Engine", "ConsoleVariables", True),
        ("Can Climb", "vein.Zombies.CanClimb", "Zombies climb walls.", "bool", "Engine", "ConsoleVariables", True),
        ("Infection Chance", "vein.ZombieInfectionChance", "Prob on Hit (0.01 = 1%).", "str", "Engine", "ConsoleVariables", "0.01"),
        ("Damage Mult", "vein.Zombies.DamageMultiplier", "Zombie Dmg Output.", "str", "Engine", "ConsoleVariables", "1.0"),
        ...
        ("Stagger Chance", "vein.StaggerChance", "Chance on hit (0.1 = 10%).", "str", "Engine", "ConsoleVariables", "0.1"),
        ("Stun Chance", "vein.StunLockChance", "Chance on hit (0.6 = 60%).", "str", "Engine", "ConsoleVariables", "0.6"),
        ("Walker %", "vein.AISpawner.ZombieWalkerPercentage", "0.8 = 80% Walkers.", "str", "Engine", "ConsoleVariables", "0.8"),
    ],
    "PVP & Vehicles": [
        ("Enable PvP", "vein.PvP", "Player vs Player combat.", "bool", "Engine", "ConsoleVariables", True),
        ("Vehicle Player Dmg", "vein.Vehicles.Damage.OutgoingPlayerDamage", "Collision damage (Higher=More).", "str", "Engine", "ConsoleVariables", "1.0"),
        ("Permadeath", "vein.Permadeath", "Character deleted on death.", "bool", "Engine", "ConsoleVariables", False),
        ("Iron Man Mode", "vein.NoSaves", "No manual saves allowed.", "bool", "Engine", "ConsoleVariables", False),
        ("Base Damage", "vein.BaseDamage", "Can bases be damaged?", "bool", "Engine", "ConsoleVariables", True),
        ("Player Raid Base", "vein.BuildObjectPvP", "Can players damage bases?", "bool", "Engine", "ConsoleVariables", True),
        ("Structure Decay", "vein.BuildObjectDecay", "Abandoned structures decay?", "bool", "Engine", "ConsoleVariables", True),
        ("Decay Interval", "vein.UtilityCabinet.Interval", "Hours between decay ticks.", "str", "Engine", "ConsoleVariables", "4.0"),
        ("Offline Protection", "vein.OfflineRaidProtection", "Reduce offline dmg.", "bool", "Engine", "ConsoleVariables", False),
        ("Pickpocketing", "vein.AllowPickpocketing", "Steal inventory?", "bool", "Engine", "ConsoleVariables", True),
        ("Headshot Mult", "vein.HeadshotDamageMultiplier", "PVP Dmg Multiplier.", "str", "Engine", "ConsoleVariables", "1.9"),
    ]
}